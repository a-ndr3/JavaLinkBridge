...
namespace IO.Swagger.Model
{
        ...
        public partial class WorkspaceDTO : BaseDTO,  IEquatable<WorkspaceDTO>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as WorkspaceDTO);
        }

        /// <summary>
        /// Returns true if WorkspaceDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkspaceDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkspaceDTO input)
        {
            if (input == null)
                return false;
