...
namespace IO.Swagger.Model
{
    ...
    public partial class InstanceTypeDTO : BaseDTO, IEquatable<InstanceTypeDTO>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstanceTypeDTO {\n");
        ...
        {
            return this.Equals(input as InstanceTypeDTO);
        }

        /// <summary>
        /// Returns true if InstanceTypeDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of InstanceTypeDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstanceTypeDTO input)
        {
            if (input == null)
                return false;
